        ...
        <div ref={saRef} style={{ transform: 'translateY(50px)' }}
            ...
            <div className="max-w-[1240px] relative mx-auto pt-[48px] md:pt-[56px] max-mini:px-4 px-6">
                ...
                <div className="grid place-items-center mt-4 md:mt-6">
                    <button className="uppercase h-[57px] group gap-4 flex items-center cursor-pointer hover:scale-[.95] pl-4 pr-2 rounded-full text-[14px] font-[900] bg-[#3fb33d] text-prmColor max-lmd:mr-4 transition-all duration-300">
