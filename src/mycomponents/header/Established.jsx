        ...
        <div ref={saRef} style={{ transform: 'translateY(50px)' }}
            ...
            <div className="max-w-[1240px] relative mx-auto pt-[20px] max-mini:px-4 px-6">
                ...
                <div className="grid place-items-center mt-4 md:mt-6">
                    <a href="tel:+994555555555" className="uppercase h-[57px] group gap-4 flex items-center cursor-pointer hover:scale-[.95] pl-4 pr-2 rounded-full text-[14px] font-[900] bg-currColor text-white max-lmd:mr-4 transition-all duration-300">
                        <span className="text-nowrap">Send request</span>
                        <div className="w-[40px] h-[40px] group-hover:bg-[#0f623a] text-white group-hover:rotate-[-45deg] group-hover:scale-[.95] rounded-full grid place-items-center bg-[#3fb33d] transition-all duration-300">
                            <FiArrowRight />
                        </div>
                    </a>
                </div>
