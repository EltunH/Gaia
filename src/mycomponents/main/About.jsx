            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
                <div className="text-center">
                    <div className='bg-[#eee] rounded-2xl hover:scale-[0.98] shadow-[0_0_15px_black] p-2 mb-8 transition-all duration-300'>
                        <img src="/assets/img/about1.jpg" className="mx-auto h-[50vh] md:h-[350px] w-full object-cover rounded-2xl" />
                    </div>
                ...
                <div className="text-center">
                    <div className='bg-[#eee] rounded-2xl hover:scale-[0.98] shadow-[0_0_15px_black] p-2 mb-8 transition-all duration-300'>
                        <img src="/assets/img/about2.jpg" className="mx-auto h-[50vh] md:h-[350px] w-full object-cover rounded-2xl" />
                    </div>
                    <p className="text-currColor">
                ...
                <div className="text-center">
                    <div className='bg-[#eee] rounded-2xl hover:scale-[0.98] shadow-[0_0_15px_black] p-2 mb-8 transition-all duration-300'>
                        <img src="/assets/img/about3.jpg" className="mx-auto h-[50vh] md:h-[350px] w-full object-cover rounded-2xl" />
                    </div>
                    <p className="text-currColor">
