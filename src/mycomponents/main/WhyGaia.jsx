...
export function WhyGaia() {
    ...
    return (
        <section id="why-gaia" ref={saRef} style={{ transform: 'translateY(50px)' }} className="max-w-[1240px] mx-auto max-mini:px-4 px-6 pt-10 md:pt-[80px] opacity-0 pb-8 transition-all duration-600 ease-in-out">
            <h2 className="text-center text-currColor mb-8 uppercase text-[24px] mini:text-[28px] md:text-[40px] font-[900]">Why gaia ?</h2>
            <div className="flex max-md:flex-col gap-[15px]">
                <div className="md:w-[33%] md:min-h-[210px] hover:scale-[0.98] rounded-2xl bg-currColor max-md:p-[30px_15px] md:p-[30px_15px] transition-all duration-300">
            ...
            <h2 className="mt-[50px] leading-[1.115em] capitalize text-currColor text-center font-[600] text-[22px] md:text-[32px]">Investing in HR capital – one of the key drivers of GAIA success in the region</h2>
        </section>
    )
}